...
class AdminContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '3306', 'dbname' => 'lavanderias', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setProxyDir('C:\\xampp\\htdocs\\lavanderias/var/cache/prod//doctrine/orm/Proxies');
        $a->setProxyNamespace('Proxies');
        $a->setAutoGenerateProxyClasses(false);
        $a->setClassMetadataFactoryName('Doctrine\\ORM\\Mapping\\ClassMetadataFactory');
        $a->setDefaultRepositoryClassName('Doctrine\\ORM\\EntityRepository');
        $a->setNamingStrategy(${($_ = isset($this->services['prestashop.database.naming_strategy']) ? $this->services['prestashop.database.naming_strategy'] : ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('mm_'))) && false ?: '_'});
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_a9fdb33674b7b3745638da3f05f28b8cadb80f8c0d5e389c85af9977215ec63f');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\lavanderias/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\lavanderias/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('mm_');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\xampp\\htdocs\\lavanderias/app/',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\lavanderias/var/cache/prod/',
            'kernel.active_modules' => [
                ...
                59 => 'ps_facetedsearch',
                60 => 'cz_imageslider',
                61 => 'cz_servicecmsblock',
                62 => 'cz_categorylistblock',
                63 => 'cz_featuredproducts',
                64 => 'cz_newproducts',
                65 => 'cz_bestsellers',
                66 => 'cz_bannercmsblock',
                67 => 'cz_parallaxcmsblock',
                68 => 'cz_brandlogo',
                69 => 'cz_instagramblock',
                70 => 'cz_footercmsblock',
                71 => 'cz_blockpaymentlogo',
                72 => 'cz_leftbanner',
                73 => 'ps_cashondelivery',
                74 => 'historyServiceMom',
                75 => 'mercadopago',
                76 => 'whatsappchat',
                77 => 'ps_newproducts',
                78 => 'ps_bestsellers',
                79 => 'ps_specials',
                80 => 'ps_categoryproducts',
                81 => 'blockwishlist',
                82 => 'ps_viewedproduct',
                83 => 'wbblocksearch',
                84 => 'wbblog',
                85 => 'wbcategoryfeature',
                86 => 'wbcategoryfeaturedproducts',
                87 => 'wbcenterbanner',
                88 => 'wbcompare',
                89 => 'wbimageslider',
                90 => 'wbimgbanner',
                ...
                93 => 'wbimgleft',
                94 => 'wbimgoffer',
                95 => 'wbleftfeaturedproducts',
                96 => 'wblogoslider',
                97 => 'wbmegamenu',
                98 => 'wbpopupproducts',
                99 => 'wbproductcomments',
                100 => 'wbstaticblocks',
                101 => 'wbthemeconfigurator',
                102 => 'wbthemecustomizer',
            ],
            'ps_cache_dir' => 'C:\\xampp\\htdocs\\lavanderias/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\lavanderias/var/cache/prod//doctrine/orm/Proxies',
