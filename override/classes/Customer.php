...
class Customer extends CustomerCore
{
    ...
    /** @var string phone_main number */
    public $phone_main;

    /** @var int service */
    public $service;

    /** @var string product_service */
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'phone_main' => array('type' => self::TYPE_STRING, 'validate' => 'isPhoneNumber', 'size' => 32),
            'service' => array('type' => self::TYPE_INT, 'size' => 3),
            'product_service' => array('type' => self::TYPE_STRING, 'size' => 100),
    ...
    public static function getHistoryMovesBalance($idCustomer) {
      $sql = "SELECT mb.*, o.reference, o.total_paid_tax_incl, od.product_quantity, od.total_price_tax_incl, od.total_price_tax_excl
              FROM ". _DB_PREFIX_ ."history_moves_balance mb
              LEFT JOIN ". _DB_PREFIX_ ."orders o ON mb.id_order = o.id_order
              LEFT JOIN ". _DB_PREFIX_ ."order_detail od ON mb.id_order_detail = od.id_order_detail
              WHERE mb.id_mom = ".$idCustomer."
              AND mb.`show` = 1
              ORDER BY mb.date_generate DESC";
